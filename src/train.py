...
# Released under the BSD 3-Clause License Agreement.
...
# Constants
CONFIG_PATH = str(Path(__file__).parent.joinpath("configs").resolve())
...
def train(cfg: DictConfig) -> Tuple[Dict, Dict]:
    ...
    Returns:
        Tuple[dict, dict]: A tuple of two dictionaries with metrics and all
        instantiated objects, respectively.
    """
...
@hydra.main(CONFIG_PATH, CONFIG_NAME, VERSION_BASE)

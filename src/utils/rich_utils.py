"""Rich utilities for logging and printing config tree.
...
def print_config_tree(
    ...
    if save_to_file:
        with open(
            Path(cfg.paths.output_dir, "config_tree.LOGGER"), "w"
        ) as file:
...
def enforce_tags(cfg: DictConfig, save_to_file: bool = False) -> None:
    ...
    if save_to_file:
        with open(Path(cfg.paths.output_dir, "tags.LOGGER"), "w") as file:

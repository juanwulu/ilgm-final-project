...
def task_wrapper(task_func: Callable) -> Callable:
    ...
    - mark the run as failed with a dedicated file in the `LOGGERs/` folder
    ...
    def wrap(cfg: DictConfig):
        ...
        # things to do if exception occurs
            ...
            # Optuna, you might want to disable raising the below
...
def get_metric_value(metric_dict: dict, metric_name: str) -> float:
    """Safely retrieves value of the metric LOGGERged in LightningModule."""
    ...
    if metric_name not in metric_dict:
        raise Exception(
            ...
            "Make sure metric name LOGGERged in LightningModule is correct!\n"
            "Make sure your `optimized_metric` name in"
